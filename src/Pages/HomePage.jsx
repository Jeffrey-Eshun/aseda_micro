   ...
   <>
            ...
            <div className="outline">
              <div className="entries">
                ...
                <select name="text" id="entry">
                  <option value="">Create an Account with Us</option>
                  <option value="">Transactional enquaries</option>
                  <option value="">Staff information</option>
                  <option value="">Credebity</option>
                </select>
              </div>
              <div className="entries">
      ...
      <div className="grid-mission">
            <div className="grid-miss">
                   ...
                   <div className="txt-1">
                    <p>The dollar rating remains strong, reflecting global economic stability.</p>
                   </div>
            </div>
            ...
            <div className="image-hold"><img src="public/download.jpg" alt="IMAGE" />  </div>  
                   ...
                   <div className="txt-1">
                    <p>Personnel aptitude ensures effective skills, adaptability, and problem-solving abilities.</p>
                   </div>
            </div>
            <div className="grid-miss">
